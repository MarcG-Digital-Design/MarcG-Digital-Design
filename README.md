...
* **[VGA Video Controller](https://github.com/Digital-Systems-Engineer/fpga-vga-controller)** - A custom VGA controller implemented on FPGA to display a static image stored in internal block RAM (L3 Academic Project).
